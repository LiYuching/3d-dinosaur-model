...
function updateCube() {
    ...
    let vertices = [
        ...
        { x: 0, y: 0, z: size/4 },//21
        //body
        { x: -size/10, y: -size/8, z: size / 4 },//22
        { x: size/10, y: -size / 8, z: size / 4 },//23
        { x: 0, y: -size / 6, z: size-(size/5) },//24
        { x: -size / 5, y: 0, z: size - (size / 2) },//25
        { x: size / 5, y: 0, z: size - (size / 2) },//26
        //body2
        { x: 0, y: -size / 6, z: size+(size/4) },//27
        { x: -size / 4, y: (-size / 10) + (size / 5), z: size + (size / 4) },//28
        { x: size/4, y: (-size / 10)+(size/5), z: size + (size / 4) },//29
        { x: size / 4, y: (-size / 10) + (size / 3), z: size-(size/2) },//30
        { x: -size / 4, y: (-size / 10) + (size / 3), z: size - (size / 2) },//31
        { x: size / 4, y: (-size / 10) + (size / 2), z: size },//32
        { x: -size / 4, y: (-size / 10) + (size / 2), z: size },//33
        //arms +(bottom_Jaw_Change/2)
        { x: -size / 4, y: (-size / 10) + (size / 2) + (bottom_Jaw_Change / 2), z: size/2 - (size / 6) },//34
        { x: -size / 4 + (size / 10), y: (-size / 10) + (size / 2) + (bottom_Jaw_Change / 2), z: size/2 - (size / 6) },//35
        { x: -size / 4, y: (size / 4) - (size / 8) + (bottom_Jaw_Change / 1), z: size / 2 - (size / 3) },//36
        { x: -size / 4 + (size / 10), y: (size / 4) + (bottom_Jaw_Change / 1) - (size / 8), z: size / 2 - (size / 3) },//37
        { x: -size / 4, y: (size / 4) - (size / 20) + (bottom_Jaw_Change / 1), z: size / 2 - (size / 3)-(size/10) },//38
        { x: -size / 4 + (size / 10), y: (size / 4) + (bottom_Jaw_Change / 1) - (size / 20), z: size / 2 - (size / 3) - (size / 10) },//39
        { x: -size / 4 + ((size / 10) / 2), y: (-size / 10) + (size / 2) - (size / 10) + (bottom_Jaw_Change / 2), z: size / 2 - (size / 6) },//40
        { x: size / 4, y: (-size / 10) + (size / 2) + (bottom_Jaw_Change / 2), z: size / 2 - (size / 6) },//41
        { x: size / 4 + (size / 10), y: (-size / 10) + (size / 2) + (bottom_Jaw_Change / 2), z: size / 2 - (size / 6) },//42
        { x: size / 4, y: (size / 4) - (size / 8) + (bottom_Jaw_Change / 1), z: size / 2 - (size / 3) },//43
        { x: size / 4 + (size / 10), y: (size / 4) + (bottom_Jaw_Change / 1) - (size / 8), z: size / 2 - (size / 3) },//44
        { x: size / 4, y: (size / 4) - (size / 20) + (bottom_Jaw_Change / 1), z: size / 2 - (size / 3) - (size / 10) },//45
        { x: size / 4 + (size / 10), y: (size / 4) + (bottom_Jaw_Change / 1) - (size / 20), z: size / 2 - (size / 3) - (size / 10) },//46
        { x: size / 4 + ((size / 10) / 2), y: (-size / 10) + (size / 2) - (size / 10) + (bottom_Jaw_Change / 2), z: size / 2 - (size / 6) },//47
        //tail
        { x: ((Math.cos((game.runtime()) / 750)) * 5), y: -size/3, z: size*2.5 },//48
        //left leg
        { x:0, y: (size / 2), z: size },//49
        { x: size/4, y: (size / 2)+(size/4), z: size*1.3-(size/8) },//50
        { x: (size / 4)-(size/5), y: (size / 2) + (size / 4), z: size*1.3 - (size / 8) },//51
        { x: (size / 4)-size/10, y: (size / 2) + (size / 4), z: size*1.3 - (size / 8) + (size/5) },//52
        { x: size / 5, y: (size / 2) + (size / 4)+(size/2), z: size - (size / 8) },//53
        { x: (size / 5) - (size / 8), y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 8) },//54
        { x: (size / 5) - size / 16, y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 8) + (size / 5) },//55
        { x:0, y: (-size / 10) + (size / 3), z: size - (size / 2) },//56
        { x:0, y: (-size / 10) + (size / 5), z: size + (size / 4) },//57
        { x: size / 5, y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 5) },//58
        { x: (size / 5) - (size / 8), y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 5) },//59
        { x:(size/5)- size/16, y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 8) },//60
        //right leg
        { x: 0, y: (size / 2), z: size },//61
        { x: -size / 4, y: (size / 2) + (size / 4), z: size * 1.3 - (size / 8) },//62
        { x: -(size / 4) + (size / 5), y: (size / 2) + (size / 4), z: size * 1.3 - (size / 8) },//63
        { x: -(size / 4) + size / 10, y: (size / 2) + (size / 4), z: size * 1.3 - (size / 8) + (size / 5) },//64
        { x: -size / 5, y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 8) },//65
        { x: -(size / 5) + (size / 8), y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 8) },//66
        { x: -(size / 5) + size / 16, y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 8) + (size / 5) },//67
        { x: 0, y: (-size / 10) + (size / 3), z: size - (size / 2) },//68
        { x: 0, y: (-size / 10) + (size / 5), z: size + (size / 4) },//69
        { x: -size / 5, y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 5) },//70
        { x: -(size / 5) + (size / 8), y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 5) },//71
        { x: -(size / 5) + size / 16, y: (size / 2) + (size / 4) + (size / 2), z: size - (size / 8) },//72
    ];
